              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-sm backdrop-blur">
                ...
                {product?.short_description ? (
                  ...
                  <p className="mt-3 text-sm text-slate-200/80">
                    ...
                    consistent performance, clean packaging, quick dispatch.
                  </p>
                )}
                  ...
                  items={[
                    {
                      ...
                      content: product.description ? (
                        ...
                        <p>
                          Precision component designed for stable performance in
                          DIY and professional builds.
                        </p>
                      ),
                    },
                    {
                      ...
                      content: (
                        <ul className="list-disc pl-5">
                          ...
                          <li>Quality: Tested / verified (dummy)</li>
                          <li>Compliance: RoHS (dummy)</li>
                        </ul>
                      ),
                    },
                    {
                      ...
                      content: (
                        <ul className="list-disc pl-5">
                          ...
                          <li>Labelled to avoid mix-ups</li>
                        </ul>
                      ),
                    },
                    {
                      ...
                      content: (
                        <ul className="list-disc pl-5">
                          ...
                          <li>Returns: As per electronics policy</li>
                        </ul>
                      ),
                    },
                  ]}
