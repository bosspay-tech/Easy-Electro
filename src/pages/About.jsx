      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:py-24">
        <div className="text-center">
          ...
          <h1 className="mt-3 text-4xl font-extrabold tracking-tight text-white sm:text-5xl">
            EASY ONLINE ELECTRO ENTERPRISES
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            We believe in delivering quality electronic components, PCBs, ICs, and everyday essentials directly to your doorstep. With a focus on customer satisfaction and premium products, we aim to make your shopping experience seamless and secure.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-sm backdrop-blur">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300">
              To provide a curated selection of premium electronics and hardware items with transparent pricing and fast delivery.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-sm backdrop-blur">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Every component in our catalog is carefully selected to ensure you receive only the best items for your projects.
            </p>
          </div>
        ...
        <div className="mt-16 rounded-3xl bg-black/20 border border-white/10 px-6 py-12 sm:p-16 backdrop-blur">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-lg leading-8 text-slate-300">
              Discover our collection of premium electronic components today.
            </p>
